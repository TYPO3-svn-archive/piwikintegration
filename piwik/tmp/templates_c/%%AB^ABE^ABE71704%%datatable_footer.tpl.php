<?php /* Smarty version 2.6.25, created on 2009-07-04 10:26:26
			...
			<span id="exportToFormat" style="display:none;padding-left:4px;">
				<?php if ($this->_tpl_vars['properties']['show_export_as_image_icon']): ?>
					<span id="dataTableFooterExportAsImageIcon">
						<a href="javascript:OFC.jquery.popup('<?php echo $this->_tpl_vars['chartDivId']; ?>
');"><img title="<?php echo ((is_array($_tmp='General_ExportAsImage')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
