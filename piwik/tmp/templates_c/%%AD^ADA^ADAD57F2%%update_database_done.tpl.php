...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'CoreUpdater/templates/update_database_done.tpl', 2, false),array('modifier', 'implode', 'CoreUpdater/templates/update_database_done.tpl', 34, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
<?php $this->assign('helpMessage', ((is_array($_tmp='CoreUpdater_HelpMessageContent')) ? $this->_run_mod_handler('translate', true, $_tmp, '<a target="_blank" href="misc/redirectToUrl.php?url=http://piwik.org/faq/">', '</a>', '</li><li>') : smarty_modifier_translate($_tmp, '<a target="_blank" href="misc/redirectToUrl.php?url=http://piwik.org/faq/">', '</a>', '</li><li>'))); ?>
...
?>
	...
	<?php if (count ( $this->_tpl_vars['errorMessages'] ) > 0): ?>
		<div class="warning">
			<p><img src="themes/default/images/warning_medium.png"> <?php echo ((is_array($_tmp='CoreUpdater_ErrorDuringPluginsUpdates')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</p>
			<?php $_from = $this->_tpl_vars['errorMessages']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['message']):
?>
