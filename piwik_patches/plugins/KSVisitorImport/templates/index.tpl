...
{'KSVisitorImport_NotReversible'|translate:'<b>':'</b>'}<br /><br />
{'KSVisitorImport_AreYouSure'|translate}<br />
</p>
<input type="checkbox" name="choice" id="choice" value="yes" /> <label for="choice">{'KSVisitorImport_ChoiceYes'|translate}</label>
<br />
